...
create table admin(
 ...
 aname varchar(50),                    --用户名
 apwd  varchar(50),                    --密码
 res1 varchar(50),        --备用字段
 res2  varchar(20)    --备用字段
)
...
res1  varchar(50),  --备用字段
 res2  varchar(20),   --备用字段
 res3  varchar(20),  --备用字段
 res4  varchar(20)    --备用字段
...
--登录角色
create table role(
  roleid int primary key auto_increment,  --id
  rolename varchar(20) ,                   --角色名（普通用户,管理者)
  renabled   int ，   --关系是否可用(0可用，  1不可用)
  res1   varchar(20),    --备用字段
  res2  varchar(20)   --备用字段
...
create table proxy(
 ...
 prname  varchar(20),   --代理名称
 prtime   varchar(20),  --工作时间
 prprice  double(10,2),    --价格
 prremark  varchar(50),   --备注
 res1  varchar(20),    --备用字段
 res2  varchar(20),    --备用字段
 res3  varchar(20)    --备用字段
)
...
create table route(
   ...
   rname varchar(50),   --线路名称
   rvia  varchar(100) ,   --配送线路顺序
   res1  varchar(20),    --备用字段
   res2  varchar(20),    --备用字段
   res3  varchar(20),    --备用字段
   res4  varchar(20)    --备用字段
...
create table goods(
     ...
     gremark varchar(100),   --备注
     res1  varchar(50),   --备用字段
     res2    varchar(50), --备用字段
     res3  varchar(20),    --备用字段
     res4  varchar(20)    --备用字段
)
...
create table order(
     ...
     orecTel  varchar(20),   --收件人电话
      ...
      orecSpname   varchar(20),   --接件单位（配送点名)
      oremark  varchar(50),  --备注
      res1 varchar(20),    --备用字段
      res2 varchar(20),    --备用字段
      res3 varchar(20),     --备用字段
      res4  varchar(20)   --备用字段
